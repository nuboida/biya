...
const LoginPage = () => {
  return (
    <>
      <div className="relative flex p-0 overflow-hidden bg-center bg-cover h-screen py-10">
              ...
              <div className="relative flex flex-col min-w-0 mt-24 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border max-md:mt-8">
                <div className="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                  ...
                  <p className="mb-0">
                    ...
                    <Link href="/register" className="text-accent font-semibold">Register</Link>
                  </p>
                </div>
                <LoginForm />
              </div>
