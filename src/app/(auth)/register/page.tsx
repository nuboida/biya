...
const SignupPage = async () => {
  ...
  return (
    <>
        <div className="relative flex p-0 overflow-x-hidden overflow-y-auto bg-center bg-cover h-screen 2xl:py-10 lg:py-5 max-lg:py-5">
          <div className="container z-10">
            ...
            <div className="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
              ...
              <div className="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12 max-lg:hidden">
