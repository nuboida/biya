  ...
  return (
    <section>
      <div className="px-10 mb-10">
        <div className="pt-10">
          <SettingsAccordion token={String(token)} merchantId={merchantId} merchant={{businessName: merchant.businessName, merchantId: merchant.merchantId, businessEmail: merchant.businessEmail || ''}} />
        </div>
      </div>
    </section>
  )
